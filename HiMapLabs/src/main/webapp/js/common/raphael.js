...
(function (glob, factory) {
    ...
    R._engine.image = function (vml, src, x, y, w, h) {
        ...
        //xiaobing add png filter
        if(src.indexOf("png")>0){
            var filters = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + src + "', sizingmethod=scale);";
            node.style.filter = filters;
        }
